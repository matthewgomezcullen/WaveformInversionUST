...
**Please download the datasets ("uiuc" folder) under the [releases](https://github.com/matthewgomezcullen/WaveformInversionUST/releases) tab for this repository, and place that data in the [phantoms](https://github.com/matthewgomezcullen/WaveformInversionUST/tree/main/Simulations/phantoms) folder.**
